        ...
        <div className={`${toggle ? "lg:w-1/5" : "w-10"} h-screen bg-[#042954] font-roboto transition-all duration-300 ease-in-out`} >
            ...
            <div className='flex w-full justify-between items-center p-3 bg-gradient-to-r from-[#ff9d01] to-[#ffaa01]'>
                {toggle && <div className=''>
                    <h3 className='font-semibold text-xl text-white uppercase'>Student</h3>
                </div>
                }
                {toggle ?
                    <>
                        <GiHamburgerMenu className='lg:block hidden text-2xl cursor-pointer' onClick={() => setToggle(!toggle)} />
                        {/* for mobile */}
                        <GiHamburgerMenu className='text-2xl lg:hidden cursor-pointer' onClick={() => setMobile(!mobile)} />
                    </>
                    :
            ...
            <div className={`hidden lg:flex flex-col items-start text-white ${toggle ? "block" : "w-10"}`}>
                ...
                >
                    <span className={`flex ${!toggle && "justify-center"} w-full gap-4 items-center`}>
                        <MdDashboard className='text-xl' />
                        {toggle && <span className='text-sm font-semibold'>Teachers</span>}
                    </span>
