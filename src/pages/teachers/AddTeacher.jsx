                    ...
                    <div className=''>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <ClassSelect type={"Class *"}
                                placeholder="Please select gender" padding='lg:pr-4' option={section} />
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2'>
                            <div className='mb-6 '>
                                ...
                                <textarea className='bg-[#f0f1f3] h-28 w-full px-4 py-1 rounded-md focus:outline-none col-span-2' name="" id=""></textarea>
                            </div>
